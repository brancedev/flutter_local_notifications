...
void main() {
  ...
  group('macOS', () {
          ...
          await withClock(Clock.fixed(now), () async {
            ...
            const NotificationDetails notificationDetails = NotificationDetails(
                macOS: MacOSNotificationDetails(
                    ...
                    sound: 'sound.mp3',
                    badgeNumber: 1,
                    attachments: <MacOSNotificationAttachment>[MacOSNotificationAttachment('video.mp4', identifier: '2b3f705f-a680-4c9f-8075-a46a70e28373')]));
    ...
    test('requestPermissions with all settings requested', () async {
      await flutterLocalNotificationsPlugin.resolvePlatformSpecificImplementation<MacOSFlutterLocalNotificationsPlugin>()!.requestPermissions(sound: true, badge: true, alert: true);
      expect(log, <Matcher>[
        isMethodCall('requestPermissions', arguments: <String, Object>{
          'sound': true,
          'badge': true,
